    ...
    <>
      ...
      <div className="visit-layout" id="overview">
        <div className="visit-content">
          ...
          <section className="section-block" id="media"><div className="section-heading"><div><h2>Материалы</h2><p>Фото и видео, подтверждённые сервером</p></div><StatusPill label={`${visit.mediaCount} файлов`} tone="neutral" /></div><div className="media-grid"><div className="media-placeholder brake"><Icon name="camera" /><span>Тормозной механизм</span></div><div className="media-placeholder wheel"><Icon name="camera" /><span>Передняя подвеска</span></div><div className="media-placeholder intake"><Icon name="camera" /><span>Фото приёмки</span></div></div></section>
        </div>
