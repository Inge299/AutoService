...
- пользователь входит под учётной записью, созданной администратором веб-кабинета;
- после входа Android получает ограниченный bearer-токен, без встроенных серверных ключей;
